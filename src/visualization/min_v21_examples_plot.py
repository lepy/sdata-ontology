"""Render three category-modality plots for examples/min-v3.0.0-examples.ttl."""
...
DEFAULT_INPUT = Path("examples/min-v3.0.0-examples.ttl")
DEFAULT_OUT_DIR = Path("docs/diagrams")
DEFAULT_BASE = "min-v3.0.0-examples"
