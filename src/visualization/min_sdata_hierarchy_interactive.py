        ...
        <body>
          <div class="layout">
            <aside class="sidebar">
              <h1>{title}</h1>
              <div class="meta">
                Interactive class hierarchy for MIN v3.2.0 and sdata-core.
              </div>
              <div class="controls">
                <div>
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    ...
    parser.add_argument("--min", dest="min_path", type=Path, default=Path("min-v3.2.0.ttl"))
    ...
    parser.add_argument("--title", default="Interactive Class Hierarchy: MIN v3.2.0 -> sdata-core")
