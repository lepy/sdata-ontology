...
Kompakte Referenz fuer die Modellierung mit `MIN v1.0.0`.
Core-Profil:
...
`sdata-core` (`v0.1.0`) enthaelt u. a.:
...
## FORMA in MIN v1 (verfuegbar in sdata v0.1.0)
...
Mit `sdata-core` (`v0.1.0`) kannst du statt `min:*` die sdata-Fassaden nutzen
