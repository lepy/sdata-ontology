...
- `sdata-core.ttl`: default core profile (`v0.15.0`, MIN v3.7 based)
- `sdata-core-v0.13.1.ttl`: legacy extended core profile
- `min-v3.7.1.ttl`: foundation ontology
...
Core sizes:
- `sdata-core.ttl` (`v0.15.0`): **46 classes**, **32 object properties**, **19 datatype properties**
- `sdata-core-v0.13.1.ttl`: **35 classes**, **21 object properties**, **16 datatype properties**

## Read This First

1. Use `sdata-core.ttl` (`v0.15.0`) as default profile.
